...
object ModelCatalog {
    val models: List<ModelEntry> = listOf(
        ...
        ModelEntry("qwen3-4b", "Qwen3 4B (Recommended)", "qwen3-4b.Q4_K_M.gguf", 3.6, "2.4 GB download", 4.0, "Q4_K_M", "https://huggingface.co/Qwen/Qwen3-4B-GGUF/resolve/main/Qwen3-4B-Q4_K_M.gguf?download=true", "7485fe6f11af29433bc51cab58009521f205840f5b4ae3a32fa7f92e8534fdf5"),
